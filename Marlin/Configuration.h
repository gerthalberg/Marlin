...
#define STRING_CONFIG_H_AUTHOR "(Ghalberg, Quad Z Config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tronxy Quad Z R7 Input Shaper"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 62.4797
  #define DEFAULT_bedKi 11.8310
  #define DEFAULT_bedKd 219.9700
...
#define Y_MIN_POS -16
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 29
 ...
 */
#define Z_PROBE_END_SCRIPT "G28 X0 Y0"
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  X_BED_SIZE + 29, 100, Z_CURRENT } } 
  #define NOZZLE_CLEAN_END_POINT   { { X_BED_SIZE + 29, 200, Z_CURRENT } }
